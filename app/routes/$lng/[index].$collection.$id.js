...
function EventModalTitleBlock({ title, collection, slug }) {
  ...
  return (
    <ModalTitle title={title}>
      <StyledEventTitle>
        <a
          href={`${config.AMP_WEBSITE_URL}/${i18n.resolvedLanguage}/index/${collection}/${slug}`}
...
export default function EventModal() {
  ...
  const handleClickBtn = () => {  
    ...
    window.myIframe = document.getElementById("myIframe");
        window.url_string = "https://applicationtoevent.bubbleapps.io/version-test";
    window.url = document.location.pathname;
    window.URL = url_string+"?url="+url+"&lng="+ params.lng;
    myIframe.height="350px"
    myIframe.src = URL;

  };
  let iframe = <> <iframe src="" id="myIframe" frameborder="0" width="100%" height="0"></iframe></>    
 ...
 [
  {
   ...
   "item":
   {
    "@id": "https://inradius.space/${params.lng}",
    "name": "inRadius.space"
    }
  },
  {
  ...
  "item":
   {
     "@id": "https://inradius.space/${params.lng}/index/${params.collection}/${params.id}",
     "name": "Event"
   }
  }
 ]
